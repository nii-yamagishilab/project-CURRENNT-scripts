...
# PATH to the pyTools
export TEMP_WAVEFORM_PROJECT_PYTOOLS_PATH=/work/smg/wang/GIT/TEAM/project-CURRENNT-public/pyTools/

# PATH to currennt
export TEMP_WAVEFORM_PROJECT_CURRENNT_PATH=/work/smg/wang/GIT/TEAM/project-CURRENNT-public/CURRENNT_codes/build/currennt
