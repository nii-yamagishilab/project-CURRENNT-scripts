...
# 
export TEMP_ACOUSTIC_MODEL_INPUT_DIRS=$PWD/../TESTDATA/vctk_anonymize/ppg,$PWD/../TESTDATA/vctk_anonymize/xvector,$PWD/../TESTDATA/vctk_anonymize/f0
...
export TEMP_ACOUSTIC_NETWORK_PATH=$PWD/MODELS/DAR_001/network.jsn
